...
public class PointTest {
	...
	public void testSub() {
		...
		//Added Integer.valueOf() instead of number and changed numbers
		assertEquals(Integer.valueOf(10), res1.x);
		assertEquals(Integer.valueOf(39), res1.y);
		assertEquals(Integer.valueOf(17), res2.x);
		assertEquals(Integer.valueOf(6), res2.y); // Corrected from res2.x to res2.y
	}
